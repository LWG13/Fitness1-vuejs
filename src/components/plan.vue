...
<template>
  <div class="plan" >
    <br/><br/>
     <span class="homeName">READY TO START</span>
     <span class="bold">YOUR JOURNEY</span>
      <br/><br/><br/>
       <v-container>
         <v-row >
           <v-col cols="12" sm="6" md="6" lg="4" xl="4" xxl="4" >
             <div class="plan-item" >
               <img :src="heart" alt="heart" height="90px" loading="lazy"/>
               <br/><br/>
               <h1>Basic Plan</h1>
               <br/>
           ...
           <v-col cols="12" sm="6" md="6" lg="4" xl="4" xxl="4" >
            <div class="plan-item-pre" >
               <img :src="crown" alt="heart" height="90px" loading="lazy"/>
               <br/><br/>
               <h1>Premium Plan</h1>
               <br/>
           ...
           <v-col cols="12" sm="6" md="6" lg="4" xl="4" xxl="4" >
             <div class="plan-item" >
               <img :src="plate" alt="heart" height="90px" loading="lazy"/>
               <br/><br/>
               <h1>Pro Plan</h1>
               <br/>
