...
<template>
  <div class="program">
    <span class="homeName">WELLCOME TO</span>
            <span class="homeName">
             OUR <b class="bold">PROGRAM</b>
            </span>
    <div class="program-cpntent">
      <v-container>
        <v-row class="pa-2">
          <v-col cols="12" sm="4" lg="4" >
            <div class="card" >
              <img :src="plate" alt="plate" loading="lazy" height="105px"/>
          ...
          <v-col cols="12" sm="4" lg="4" >
            <div class="card" >
              <img :src="heart" alt="plate" loading="lazy" height="105px"/>
...
This programs is designed for those who exercises only for their body fitness not body building</p>
          ...
          <v-col cols="12" sm="4" lg="4" >
            <div class="card" >
              <img :src="run" alt="plate" loading="lazy" height="105px"/>
          ...
          <v-col cols="12" sm="4" lg="4" >
            <div class="card" >
              <img :src="fire" alt="plate" loading="lazy" height="105px"/>
              <h2>Fat Burning</h2>
          ...
          <v-col cols="12" sm="4" lg="4" >
            <div class="card" >
              <img :src="crown" alt="club" loading="lazy" height="105px"/>
              <h2>Club Activity</h2>
